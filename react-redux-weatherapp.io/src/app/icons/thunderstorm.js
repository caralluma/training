...
const thunderstorm = (props) => (
    <svg id="thunderstorm" viewBox="0 0 72 72" strokeWidth="0.5" {...props}>
      <g>
        ...
        <path d="M37.2,34c-0.9-0.7-2.1-0.6-2.8,0.3L21.8,50l8,0l-7,8.7c-0.7,0.9-0.6,2.1,0.3,2.8c0.4,0.3,0.8,0.4,1.2,0.4
